...
export default class SuppressionFerieController {
    constructor($uibModalInstance, connexionService, suppressionFerieService, idFerie, date, type) {
    ...
    valider() {
        ...
        this.suppressionFerieService.supprimerFerie(ferie).then((result) => {
			if(result.data){
		...
		let str = "Suppression "
		str += (this.type=='RTT employeur')? 'de la RTT employeur' : 'du jour ferié'
    }
